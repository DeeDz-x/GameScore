...
def popular_games():
    game = Game(1, "Far cry 3", datetime.now(), "Ein Intressantes spiel", "Karl Müller", datetime.now(), datetime.now(),
                Publisher(1, "Test Name", "Test Beschreibung", "Test Webseite"), Usk(1, "18", 1), genre=[Genre(1, "Shooter", "Es geht um waffen gewalt", datetime.now())])  # = database.get_popular_game_by_id(id)
...
def new_games():
    game = Game(1, "Far cry 3", datetime.now(), "Ein Intressantes spiel", "Karl Müller", datetime.now(), datetime.now(),
                Publisher(1, "Test Name", "Test Beschreibung", "Test Webseite"), Usk(1, "18", 1), genre=[Genre(1, "Shooter", "Es geht um waffen gewalt", datetime.now())])  # = database.get_new_game_by_id(id)
    res = extract_game(game)
    return jsonify(res), 200, {"Content-Type": "application/json"}
...
def games():
    game = Game(1, "Far cry 3", datetime.now(), "Ein Intressantes spiel", "Karl Müller", datetime.now(), datetime.now(),
                Publisher(1, "Test Name", "Test Beschreibung", "Test Webseite"), Usk(1, "18", 1), genre=[Genre(1, "Shooter", "Es geht um waffen gewalt", datetime.now())])  # = database.get_game_by_id(id)
    res = extract_game(game)
    return jsonify(res), 200, {"Content-Type": "application/json"}
...
def game(id):
    game = Game(1, "Far cry 3", datetime.now(), "Ein Intressantes spiel", "Karl Müller", datetime.now(), datetime.now(),
                Publisher(1, "Test Name", "Test Beschreibung",
                          "Test Webseite"), Usk(1, "18", 1),
                genre=[Genre(1, "Shooter", "Es geht um waffen gewalt", datetime.now())], review=[Review(1, "Test Text", 3, datetime.now(), datetime.now(), False)])  # = database.get_game_by_id(id)
    game = Game(2, "test 2", datetime.now(), "Ein Intressantes spiel", "Karl Müller", datetime.now(), datetime.now(),
                Publisher(1, "Test Name", "Test Beschreibung",
                          "Test Webseite"), Usk(1, "18", 1),
                genre=[Genre(1, "Shooter", "Es geht um waffen gewalt", datetime.now())], review=[Review(1, "Test Text", 3, datetime.now(), datetime.now(), False)])
    res = extract_game(game)
...
def game_reviews(id):
    game = Game(1, "Far cry 3", datetime.now(), "Ein Intressantes spiel", "Karl Müller", datetime.now(), datetime.now(),
                Publisher(1, "Test Name", "Test Beschreibung",
                          "Test Webseite"), Usk(1, "18", 1),
                genre=[Genre(1, "Shooter", "Es geht um waffen gewalt", datetime.now())], review=[Review(1, "Test Text", 3, 1, datetime.now(), datetime.now(), False,
                                                                                                        [Comment(1, "Test Text 2", datetime.now, datetime.now, False)])])

    profile = Profile(True, 20, "Deutschland", "Karl Müller", "Bio", 3, [Game_account(
        1, "Steam", "KARLMÜLLERXX", "date")], user=User(1, "Karl Müller", "Mail", "pass", datetime.now()))  # = database.get_review_by_id(id)

    res = {"id": game.get_review()[0].get_id(),
    ...
    if comment is not None:
        res["comment"] = {"id": game.get_review()[0].get_comments()[0].get_id(),
...
def genre():
    genre = Genre(1, "shooter", "Es geht um waffen gewalt",
                  datetime.now())  # = database.get_genre_by_id(id)
    res = {"id": genre.get_id(),
           "name": genre.get_name(),
